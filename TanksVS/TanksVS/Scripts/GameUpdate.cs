...
{
    public static void Update(GameTime gameTime, Game1 game, ContentManager content, GraphicsDevice graphics)
    {
        ...
        {
            player.Control(gameTime, keys, game.Collision, game.DieCollision, game.SlowCollision);
